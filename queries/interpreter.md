...
- Query analyzers and `irep_node`s
  ...
  - `GraphQL::Execution::Lookahead` for field-level info about child selections
  - `GraphQL::Analysis::AST` for query analysis which is compatible with the new interpreter
