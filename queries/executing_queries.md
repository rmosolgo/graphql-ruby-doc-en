...
Note that `context` is _not_ the hash that you passed it. It's an instance of `GraphQL::Query::Context`, but it delegates `#[]`, `#[]=`, and a few other methods to the hash you provide.
